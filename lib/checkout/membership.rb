...
module CbCheckout
  module Membership    
    BASIC       = {:name => "Basic Crimson Bikes Membership", :description => "Enables you to checkout up to 1 bike at a time for a duration of up to 5 hours", :unit_price => Money.new(10, "USD"), :quantity => 1}
